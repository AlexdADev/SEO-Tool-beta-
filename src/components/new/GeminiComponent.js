...
function GeminiComponent({ pages, pageRank, selectedLinks }) {
    ...
    }, [generate, pages, pageRank, selectedLinks]);
            ...
            data: {
                "contents": [{
                    "parts": [
                      ...
                      🔗 **Enlaces entre páginas:** ${selectedLinks.length > 0 ? selectedLinks.join(', ') : "No hay enlaces definidos"}  
